    ...
    <section className="relative bg-black text-white">
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Familie genießt gemeinsam Premium-IPTV auf einem großen Fernseher im Wohnzimmer"
          ...
          <div className="flex justify-center mt-16">
            <div className="w-full max-w-[366px]">
              <img
                ...
                alt="Unterstützte Geräte: Smart TV, Laptop, PC, Android, iOS und Windows für IPTV-Streaming"
                width={366}
                height={63}
